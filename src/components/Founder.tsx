              ...
              <div className="relative">
                <div className="overflow-hidden rounded-2xl shadow-[0_12px_60px_rgba(17,17,17,0.1)]">
                  <img
                    ...
                    alt="Sai Pavan Rali, founder of Orvélia"
                    loading="lazy"
            ...
            <Reveal delay={150}>
              <div>
                ...
                <p className="mt-7 text-sm font-light leading-relaxed text-charcoal/60">
                  Orvélia was founded with a vision to create timeless jewellery that celebrates elegance, craftsmanship and unforgettable moments. Every collection is designed with passion, precision and luxury.
                </p>
